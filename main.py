...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # ✅ LINHA ALTERADA: adicionou permissions e geolocation
        ...
        try:
            ...
            # ✅ LINHAS ADICIONADAS: fecha qualquer modal/overlay
            await page.keyboard.press("Escape")
            await page.wait_for_timeout(2000)
            await page.keyboard.press("Escape")
            await page.wait_for_timeout(2000)

            await page.locator('xpath=/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[2]/div[1]/div[3]/div/div[1]/div/div/div/div/div[3]/span').click()
            await page.wait_for_timeout(8000)
